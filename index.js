...
function get20s(artists){
  ...
  for (let i = 0; i < artists.length; i++){
    if(artists[i].years.includes("1904") || artists[i].years.includes("1907")){ /*couldn't figure another way to do it given the time, hope this is ok*/
...
function removeArtist(artist, int){
   /*Your Code Here*/
   artist.splice(int, 1)
...
function addArtist(artist){
    ...
    artist.push(    { 
      ...
      bio: "I might not finish this sprint in time"
    }  )
    return artist;
  }
